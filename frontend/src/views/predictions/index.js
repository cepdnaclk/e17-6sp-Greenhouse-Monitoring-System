...
const index = () => {
    ...
    return (
        ...
        <CCol>
            ...
            <br></br>
            <br></br>
        <CCard href="#" style={{ height: '3rem', width: '25rem', textAlign: 'left' }}>Number of Diseases:  2</CCard>
        <br></br>
        <br></br>    
        ...
        <CCard href="#" style={{ height: '3rem', width: '25rem', textAlign: 'left' }}>Names of Diseases    : 
        </CCard>
        <CCard>
        <ol>
            <li>Tomatomosaicvirus</li>
            <li>Target Bacterial_spot</li>
        </ol>
        <br></br>
        <br></br>
        </CCard>
